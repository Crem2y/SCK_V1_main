...
byte SCK_PM_keyset[KEY_LAYERS][PM_V][PM_H] = { // for keyPad Module (FN, V, H)
  ...
  {{M_LB,M_MB,M_RB,MH_U}, // fn1 key layer
   {M_UL,M_U ,M_UR,MH_D},
   {M_L ,M_LB,M_R ,K___},
   {M_DL,M_D ,M_DR,0xE0},
   {0xEA,K___,0xEB,K___}},

  {{0xDB,0xDC,0xDD,0xDE}, // fn2 key layer
   {0xE7,0xE8,0xE9,0xDF},
   {0xE4,0xE5,0xE6,K___},
   {0xE1,0xE2,0xE3,0xE0},
   {0xEA,K___,0xEB,K___}}
...
byte SCK_MM_keyset[KEY_LAYERS][MM_V+2][MM_H] = { // for Macro Module (FN, V, MM_num)
  {{0x00,0x00,0x00,0x00,0x00}, // normal key layer
   ...
   {0x00,0x00,0x00,0x00,0x00},
   {0xF0,0xF6,0x00,0x00,0x00},
   {0xF1,0xF7,0x00,0x00,0x00},
   {0xF2,0xF8,0x00,0x00,0x00},
   {0xF3,0xF9,0x00,0x00,0x00},
   {0xF4,0xFA,0x00,0x00,0x00},
   {0xF5,0xFB,0x00,0x00,0x00}},

  {{0x00,0x00,0x00,0x00,0x00}, // fn1 key layer
   {0x00,0x00,0x00,0x00,0x00},
   {0xDF,0xDD,0x00,0x00,0x00}, // key data start
   {0xDE,0xDC,0x00,0x00,0x00},
   {' ' ,0xEB,0x00,0x00,0x00},
   {0xE1,0xE6,0x00,0x00,0x00},
   {0xE2,0xE7,0x00,0x00,0x00},
   {0xE3,0xE8,0x00,0x00,0x00},
   {0xE4,0xE9,0x00,0x00,0x00},
   {0xE5,0xEA,0x00,0x00,0x00}},
