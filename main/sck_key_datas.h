...
byte SCK_KM_keyset[KEY_LAYERS][KM_V][KM_H] = { // for Keyboard Module (FN, V, H)
  ...
  {{0xB1,K___,0xC2,0xC3,0xC4,0xC5,0xC6,0xC7,0xC8,0xC9,0xCA,0xCB,0xCC,0xCD}, // fn key layer
   {'`' ,'1' ,'2' ,'3' ,'4' ,'5' ,'6' ,'7' ,'8' ,'9' ,'0' ,'-' ,'=' ,0xB2},
   {0xB3,'q' ,'w' ,'e' ,'r' ,'t' ,'y' ,'u' ,'i' ,'o' ,'p' ,'[' ,']' ,'\\'},
   {0xC1,'a' ,'s' ,'d' ,'f' ,'g' ,'h' ,'j' ,'k' ,'l' ,';' ,'\'',K___,0xB0},
   {0x81,'z' ,'x' ,'c' ,'v' ,'b' ,'y' ,'m' ,',' ,'.' ,'/' ,K___,K___,0x85},
...
byte SCK_MM_keyset[KEY_LAYERS][MM_V+2][MM_H] = { // for Macro Module (FN, V, MM_num)
  {{0x00,0x07,0x00,0x00,0x00}, // normal key layer
   {0x00,0x27,0x00,0x00,0x00},
   {C_VD,F_01,0x00,0x00,0x00}, // key data start
   {C_VU,F_02,0x00,0x00,0x00},
   {C_VM,'c' ,0x00,0x00,0x00},
   {'4' ,'d' ,0x00,0x00,0x00},
   {'5' ,'e' ,0x00,0x00,0x00},
   {'6' ,'f' ,0x00,0x00,0x00},
   {F_01,'g' ,0x00,0x00,0x00},
   {F_02,'h' ,0x00,0x00,0x00}},
